import svgPaths from "./svg-ua0an91ho2";
...
import imgRectangle27 from "../assets/placeholders/property.png";
import imgRectangle28 from "../assets/placeholders/property.png";
import imgRectangle29 from "../assets/placeholders/property.png";
import imgRectangle30 from "../assets/placeholders/property.png";
import imgRectangle15 from "../assets/placeholders/property.png";
import imgRectangle16 from "../assets/placeholders/property.png";
import imgRectangle17 from "../assets/placeholders/property.png";
import { imgEllipse11 } from "./svg-m88vi";
...
function Group() {
  return (
    <div className="absolute contents left-0 top-0">
      ...
      <div className="absolute bg-gradient-to-b from-[42.988%] from-[rgba(0,0,0,0)] h-[164px] left-0 rounded-[16px] to-[rgba(0,0,0,0.7)] top-0 via-[42.994%] via-[rgba(0,0,0,0)] w-[224px]" />
    </div>
  );
}
    ...
    <div className="absolute contents left-0 top-0">
      <div className="absolute h-[164px] left-0 rounded-[16px] top-0 w-[224px]">
        <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[16px]">
          <div className="absolute bg-[#22212a] inset-0 rounded-[16px]" />
          <div className="absolute inset-0 overflow-hidden rounded-[16px]">
            <img alt="" className="absolute h-[135.77%] left-[-29.46%] max-w-none top-[-17.89%] w-[149.11%]" src={imgRectangle4} />
          </div>
        </div>
      </div>
...
function Recommend() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] items-start left-[24px] top-[344px]" data-name="Recommend">
      <Tittle />
      <Card />
    </div>
  );
...
function Tittle1() {
  return (
    <div className="content-stretch flex items-center justify-between not-italic relative shrink-0 text-nowrap w-[327px]" data-name="Tittle">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] relative shrink-0 text-[#1f2a37] text-[16px]">Popular for you</p>
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[14px] relative shrink-0 text-[#fe456a] text-[12px]">See all</p>
    </div>
  );
}
    ...
    <div className="absolute inset-[12.5%_10.43%_12.51%_10.42%]" data-name="Heart">
      <div className="absolute inset-[-4.17%_-3.93%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20.4903 19.4983">
          <g id="Heart">
            <path clipRule="evenodd" d={svgPaths.p216b8180} fillRule="evenodd" id="Stroke 1" stroke="var(--stroke-0, #F97066)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
            <path d={svgPaths.p397f9660} id="Stroke 3" stroke="var(--stroke-0, #F97066)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          </g>
        </svg>
      </div>
    </div>
...
function Frame35() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0 w-full">
      <p className="basis-0 font-['Inter:Semi_Bold',sans-serif] font-semibold grow h-[18px] leading-[18px] min-h-px min-w-px not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#1f2a37] text-[14px] text-nowrap">Rose Garden</p>
      <IconlyLightHeart />
    </div>
  );
}
    ...
    <div className="relative shrink-0 w-full" data-name="Loc">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[4px] items-center pl-0 pr-[16px] py-0 relative w-full">
          ...
          <p className="basis-0 font-['Inter:Regular',sans-serif] font-normal grow h-[14px] leading-[14px] min-h-px min-w-px not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#9da4ae] text-[10px] text-nowrap">Nyarutarama</p>
        </div>
      </div>
    </div>
  );
...
function Star() {
  return (
    <div className="absolute inset-[10.42%_8.32%_10.41%_8.33%]" data-name="Star">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10.0013 9.50065">
        <g id="Star">
          <path d={svgPaths.p2b0edb00} fill="var(--fill-0, #FDB022)" id="Star_2" />
        </g>
      </svg>
    </div>
  );
...
function Frame6() {
  return (
    <div className="bg-[#fffaeb] content-stretch flex gap-[2px] items-center px-[8px] py-[6px] relative rounded-[8px] shrink-0">
      <IconlyBoldStar />
...
function Price2() {
  return (
    <div className="content-stretch flex gap-[33px] items-center relative shrink-0 w-full" data-name="Price">
      <p className="basis-0 font-['Inter:Semi_Bold',sans-serif] font-semibold grow leading-[14px] min-h-px min-w-px not-italic relative shrink-0 text-[#1f2a37] text-[10px]">$120/night</p>
      <Frame6 />
    </div>
  );
}
...
function Card3() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] h-[84px] items-start justify-center relative rounded-[8px] shrink-0 w-[327px]" data-name="card">
      <CardList />
...
function Heart3() {
  return (
    <div className="absolute inset-[10.42%_8.33%_10.41%_8.33%]" data-name="Heart">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20.0002 19.0002">
        <g id="Heart">
          <path clipRule="evenodd" d={svgPaths.peeabb80} fill="var(--fill-0, #F97066)" fillRule="evenodd" id="Heart_2" />
        </g>
      </svg>
    </div>
  );
...
function IconlyBoldHeart2() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Iconly/Bold/Heart">
      <Heart3 />
    </div>
  );
}
...
function Frame36() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0 w-full">
      <p className="basis-0 font-['Inter:Semi_Bold',sans-serif] font-semibold grow h-[18px] leading-[18px] min-h-px min-w-px not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#1f2a37] text-[14px] text-nowrap">Elizabeth</p>
      <IconlyBoldHeart2 />
    </div>
  );
}
...
function Desc3() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-full" data-name="Desc">
      <div className="h-[62px] relative rounded-[6px] shrink-0 w-[80px]">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-[6px] size-full" src={imgRectangle12} />
      </div>
      <Frame8 />
    </div>
  );
    ...
    <div className="relative shrink-0 w-full" data-name="Loc">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[4px] items-center pl-0 pr-[16px] py-0 relative w-full">
          ...
          <p className="basis-0 font-['Inter:Regular',sans-serif] font-normal grow h-[14px] leading-[14px] min-h-px min-w-px not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#9da4ae] text-[10px] text-nowrap">Nyarutaram</p>
        </div>
      </div>
    </div>
  );
...
function Price4() {
  return (
    <div className="content-stretch flex gap-[33px] items-center relative shrink-0 w-full" data-name="Price">
      <p className="basis-0 font-['Inter:Semi_Bold',sans-serif] font-semibold grow leading-[14px] min-h-px min-w-px not-italic relative shrink-0 text-[#1f2a37] text-[10px]">$180/night</p>
      <Frame11 />
    </div>
  );
}
    ...
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-full" data-name="Desc">
      <div className="h-[62px] relative rounded-[6px] shrink-0 w-[80px]">
        <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[6px]">
          <img alt="" className="absolute h-[152.69%] left-[-42.5%] max-w-none top-[-26.34%] w-[177.5%]" src={imgRectangle4} />
        </div>
      </div>
      <Frame10 />
    </div>
    ...
    <div className="relative shrink-0 w-full" data-name="Loc">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[4px] items-center pl-0 pr-[16px] py-0 relative w-full">
          ...
          <p className="basis-0 font-['Inter:Regular',sans-serif] font-normal grow h-[14px] leading-[14px] min-h-px min-w-px not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#9da4ae] text-[10px] text-nowrap">Kibagabaga</p>
        </div>
      </div>
    </div>
  );
...
function Desc5() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-full" data-name="Desc">
      <div className="h-[62px] relative rounded-[6px] shrink-0 w-[80px]">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-[6px] size-full" src={imgRectangle13} />
      </div>
      <Frame12 />
    </div>
  );
...
function Frame39() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0 w-full">
      <p className="basis-0 font-['Inter:Semi_Bold',sans-serif] font-semibold grow h-[18px] leading-[18px] min-h-px min-w-px not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#1f2a37] text-[14px] text-nowrap">{`Elizabeth Hotel `}</p>
      <IconlyBoldHeart3 />
    </div>
  );
}
...
function Price6() {
  return (
    <div className="content-stretch flex gap-[33px] items-center relative shrink-0 w-full" data-name="Price">
      <p className="basis-0 font-['Inter:Semi_Bold',sans-serif] font-semibold grow leading-[14px] min-h-px min-w-px not-italic relative shrink-0 text-[#1f2a37] text-[10px]">$230/night</p>
      <Frame15 />
    </div>
  );
}
...
function Desc6() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-full" data-name="Desc">
      <div className="h-[62px] relative rounded-[6px] shrink-0 w-[80px]">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-[6px] size-full" src={imgRectangle14} />
      </div>
      <Frame14 />
    </div>
  );
...
function PopularList() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0" data-name="Popular List">
      <Card3 />
      <Card4 />
      <Card5 />
      <Card6 />
...
function Popular() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] items-start left-[24px] top-[900px]" data-name="Popular">
      <Tittle1 />
      <PopularList />
    </div>
  );
...
function Tittle2() {
  return (
    <div className="content-stretch flex items-center justify-between not-italic relative shrink-0 text-nowrap w-[327px]" data-name="Tittle">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] relative shrink-0 text-[#1f2a37] text-[16px]">Top Locations</p>
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[14px] relative shrink-0 text-[#fe456a] text-[12px]">See all</p>
    </div>
  );
}
    ...
    <div className="bg-[#f9f5ff] content-stretch flex gap-[8px] items-center pl-[4px] pr-[8px] py-[4px] relative rounded-[10px] shrink-0">
      ...
      <div className="relative rounded-[8px] shrink-0 size-[36px]">
        <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[8px]">
          ...
          <img alt="" className="absolute max-w-none object-50%-50% object-cover rounded-[8px] size-full" src={imgRectangle27} />
        </div>
      </div>
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[14px] not-italic relative shrink-0 text-[#9da4ae] text-[12px] text-nowrap">Kibagabaga</p>
    </div>
  );
}
...
function Frame16() {
  return (
    <div className="bg-[#fe456a] content-stretch flex gap-[8px] items-center pl-[4px] pr-[8px] py-[4px] relative rounded-[10px] shrink-0">
      ...
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[14px] not-italic relative shrink-0 text-[#f9f5ff] text-[12px] text-nowrap">Kicukiro</p>
    </div>
  );
}
...
function Frame17() {
  return (
    <div className="bg-[#f9f5ff] content-stretch flex gap-[8px] items-center pl-[4px] pr-[8px] py-[4px] relative rounded-[10px] shrink-0">
      ...
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[14px] not-italic relative shrink-0 text-[#9da4ae] text-[12px] text-nowrap">Gikondo</p>
    </div>
  );
}
...
function Frame19() {
  return (
    <div className="bg-[#f9f5ff] content-stretch flex gap-[8px] items-center pl-[4px] pr-[8px] py-[4px] relative rounded-[10px] shrink-0">
      ...
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[14px] not-italic relative shrink-0 text-[#9da4ae] text-[12px] text-nowrap">Nyarutarama</p>
    </div>
  );
}
...
function TopLocation() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] items-start left-[24px] top-[792px]" data-name="Top Location">
      <Tittle2 />
      <LocationList />
    </div>
  );
...
function Nav() {
  return (
    <div className="absolute h-[86px] left-0 overflow-clip top-[1149px] w-[375px]" data-name="nav">
    ...
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-full" data-name="Desc">
      <div className="h-[62px] relative rounded-[6px] shrink-0 w-[80px]">
        <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[6px]">
          ...
          <img alt="" className="absolute max-w-none object-50%-50% object-cover rounded-[6px] size-full" src={imgRectangle15} />
        </div>
      </div>
      <Frame28 />
    </div>
  ...
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-full" data-name="Desc">
      <div className="h-[62px] relative rounded-[6px] shrink-0 w-[80px]">
        <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[6px]">
          <div className="absolute bg-[#d9d9d9] inset-0 rounded-[6px]" />
          <img alt="" className="absolute max-w-none object-50%-50% object-cover rounded-[6px] size-full" src={imgRectangle16} />
        </div>
      </div>
      <Frame30 />
    </div>
...
function IconlyLightLocation10() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Iconly/Light/Location">
      <Location11 />
    </div>
  ...
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-full" data-name="Desc">
      <div className="h-[62px] relative rounded-[6px] shrink-0 w-[80px]">
        <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[6px]">
          <div className="absolute bg-[#d9d9d9] inset-0 rounded-[6px]" />
          <img alt="" className="absolute max-w-none object-50%-50% object-cover rounded-[6px] size-full" src={imgRectangle17} />
        </div>
      </div>
      <Frame32 />
    </div>
...
export default function Home1() {
  return (
    <div className="bg-[#fcfcfd] relative size-full" data-name="Home 2">
