import svgPaths from "./svg-zmljldicqn";
...
function Name() {
  return (
    <div className="content-stretch flex gap-[4px] items-start relative shrink-0 w-full" data-name="Name">
...
function Content() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start leading-[0] not-italic relative shrink-0" data-name="Content">
      <Name />
...
export default function ListChat() {
  return (
    <div className="bg-[#fcfcfd] relative size-full" data-name="List Chat">
      ...
      <div className="absolute content-stretch flex flex-col gap-[16px] items-start left-[24px] top-[228px]" data-name="List Message">
        <ProfileChat />
        <ProfileChat1 />
        <ProfileChat2 />
        <ProfileChat3 />
